...
export default {
    ...
    introduction1: {
        text: [
            ...
            `The City of Lurn was once the center of not just the continent, but the world. It was a shining beacon of hope, said to change people for the better just by entering its vicinity.`,

            `It is still a major city, but nowhere near as radiant as it once was. Lurn’s glorious past is now the stuff of legends, thought to be the exaggerated historical accountings of an ancient city.`,
        ],
        options: [{
            id: 1,
            text: 'Continue',
